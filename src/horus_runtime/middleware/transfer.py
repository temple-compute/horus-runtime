...
class TransferMiddlewareContext:
    """
    Context passed to TransferMiddleware.
    """
...
class TransferMiddleware(
    AutoMiddleware[TransferMiddlewareContext], entry_point="transfer"
):
    """
    Base class for transfer middleware.
    """

    registry: list[type["TransferMiddleware"]]
